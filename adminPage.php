...
<body>
    ...
    <div class="header">
            ...
            <a href="mangerInfoUpgrade.php" class="edit-button">Edit Admin Information</a>
        ...
        <?php if (!empty($assignedTeachers)): ?>
            <table>
                ...
                <tbody>
                    <?php foreach ($assignedTeachers as $teachers): ?>
                        <tr>
                            <td><?= htmlspecialchars($teachers['name']) ?></td>
                            <td><?= htmlspecialchars($teachers['Phonenumber']) ?></td>
                            <td><?= htmlspecialchars($teachers['Subject']) ?></td>
                            <td><?= htmlspecialchars($teachers['level']) ?> Grade</td>
                            <td class="action-buttons">
                                <!-- Delete Button -->
                                <form method="post" style="display: inline;">
                                    <input type="hidden" name="deleteTeacherId" value="<?= htmlspecialchars($teachers['id']) ?>">
                                    <button type="submit" class="delete-button">Delete</button>
                                </form>
                                <!-- Edit Button -->
                                <a href="editTeacher.php?id=<?= htmlspecialchars($teachers['id']) ?>" class="edit-button">Edit</a>
        ...
        <div class="section">
            ...
            <form id="addTeachersForm" method="post" action="">
                ...
                <div class="input-group">
                    <label for="Phonenumber">رقم جوال المعلم</label>
                    <input name="Phonenumber" type="number" id="Phonenumber">
                </div>

                <div class="input-group">
                    <label for="Subject">المساق الذي يدرسة المعلم </label>
                    <input name="Subject" type="text" id="Subject">
                </div>

        
                <div class="input-group">
                    <label for="level">المرحلة الدراسيه التي يدرسها المعلم </label>
                    <input name="level" type="text" id="level">
                </div>

                <div >
                    <label for="Subject">الصورة الشخصية للمعلم </label>
