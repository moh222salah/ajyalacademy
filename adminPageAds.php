...
<head>
    ...
    <title>Admin Dashboard - Ads</title>
...
<body>
    ...
    <div class="header">
        ...
        <a href="mangerInfoUpgradeAds.php" class="edit-button">Edit Admin Information</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($ad['media'])): ?>
                                    <a href="<?= htmlspecialchars($ad['media']) ?>" target="_blank">View</a>
                                <?php else: ?>
                                    لا يوجد
                                <?php endif; ?>
                            </td>
                            <td class="action-buttons">
                                <form method="post" style="display: inline;">
                                    <input type="hidden" name="deleteAdId" value="<?= htmlspecialchars($ad['id']) ?>">
                                    <button type="submit" class="delete-button">Delete</button>
                                </form>
                                <a href="editAd.php?id=<?= htmlspecialchars($ad['id']) ?>" class="edit-button">Edit</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
